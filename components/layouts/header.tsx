...
const Header = () => {
    ...
    const avatar = profile.avatar_url !== null ? profile.avatar_url : '/assets/images/avatar.jpg';
                ...
                <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            <img className="inline w-8 ltr:-ml-1 rtl:-mr-1" src="/assets/images/logo-dark-sm.svg" alt="logo" />
                            <span className="hidden mt-2 font-extrabold align-middle text-2xl  transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light md:inline">inventario</span>
                        </Link>
                        <button
                            type="button"
                    ...
                    <div className="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                        ...
                        <div className="dropdown shrink-0">
                            ...
                            >
                                <ul className="grid w-[280px] grid-cols-1 gap-2 !px-2 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                        ...
                        <div className="dropdown flex shrink-0">
                            <Dropdown
                                ...
                                button={<img className="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src={avatar} alt="userProfile" />}
                            >
                                <ul className="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            <img className="h-10 w-10 rounded-md object-cover saturate-50" src={avatar} alt="userProfile" />
                                            <div className="truncate ltr:pl-4 rtl:pr-4">
                                                <h4 className="text-base">
                                                    {`${profile.first_name} ${profile.last_name}`}
                                                    <span className="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2">Pro</span>
                                                </h4>
                                                <p className="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white">{profile.email}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>

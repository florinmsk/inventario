      ...
      <div className="container max-w-5xl mx-auto">
          ...
          >
            <div className="flex justify-center items-center h-full">
              <AvatarGroup max={3}>
                <Avatar
                  classNames={{
                    base: "border-2 border-solid border-accent p-[2px] bg-transparent",
                  }}
        ...
        <div className="mt-8 flex flex-wrap gap-3 justify-center">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-neutral-900 border border-white/15 inline-flex px-3 md:px-5 py-1.5 md:py-2 rounded-2xl gap-3 items-center"
            >
              <span className="bg-accent text-neutral-950 size-5 rounded-full inline-flex justify-center items-center text-xl">
                &#10038;
              </span>
